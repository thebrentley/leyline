...
export type GameZone = 'library' | 'hand' | 'battlefield' | 'graveyard' | 'exile' | 'command';
...
export type PlaytestMessage = PlaytestSessionStartedMessage | PlaytestSessionEndedMessage | PlaytestErrorMessage | PlaytestGameStateUpdateMessage;

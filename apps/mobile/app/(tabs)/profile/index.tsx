    ...
    >
      ...
      >
        <View className={`flex-1 ${isDesktop ? "" : "items-center"}`}>
          ...
          >
            {/* Header - Desktop only (mobile uses native Drawer header) */}
            {isDesktop && (
            ...
            <View className={isDesktop ? "mt-8" : "mt-auto pt-8"}>
              <Pressable
                ...
                className={`flex-row items-center justify-center gap-2 rounded-lg border py-3 ${
                  isDark
            ...
            {/* Danger Zone */}
            <View className={isDesktop ? "mt-4 gap-3" : "mt-4 gap-3 pb-8"}>

...
import { podsApi, type PodDetail, type PodEventSummary, type PodOfflineMember } from "~/lib/api";
...
export default function PodDashboardScreen() {
  ...
  const loadPod = useCallback(async () => {
    if (!id) return;
    const [podResult, eventsResult, offlineMembersResult] = await Promise.all([
      podsApi.get(id),
      ...
      >
        ...
        <View className="flex-row items-center justify-between px-4 lg:px-6 py-3 lg:py-4">
          ...
          {isAdmin && (
            <Pressable
              ...
              className={`rounded-full p-2 ${isDark ? "active:bg-slate-800" : "active:bg-slate-100"}`}
            >
              <Settings size={22} color={isDark ? "#e2e8f0" : "#1e293b"} />
            </Pressable>
          )}
        </View>
        <ScrollView
        ...
        >
          ...
          <View className="gap-4 lg:grid lg:grid-cols-6 lg:grid-rows-[500px_auto]">
              {/* Insights Card — 3 of 4 columns */}
              <View className="lg:col-span-4">
                <View
                  className={`flex-1 rounded-2xl border p-6 lg:p-8 ${
                    isDark
                ...
                >
                  <View className="flex-1 items-center justify-center gap-3">
                    ...
                    >
                      <Calendar size={24} color={isDark ? "#64748b" : "#94a3b8"} />
                    </View>
                    <Text
              ...
              <View className="lg:col-span-2">
                <View className="flex-1 rounded-2xl justify-between">
                  <View>
            ...
            <View
              className="rounded-2xl lg:col-span-6"
            >
              <View className="flex-row items-center justify-between px-5 pt-5 pb-3">
                <Text
                  className={`text-base font-semibold ${
                ...
                <View className="flex-row items-center gap-2">
                  ...
                  {isAdmin && (
                    <Pressable
                      ...
                      className="h-6 w-6 items-center justify-center rounded-md bg-purple-600"
                    >
                ...
                {pod.pendingInvites?.map((invite) => (
                  ...
                  >
                    ...
                    <View>
                      ...
                      <View className="flex-row items-center gap-1">
                        <Clock size={10} color={isDark ? "#f59e0b" : "#d97706"} />
                  ...
                  .map((offlineMember) => (
                    ...
                    >
                      ...
                      <View>
                        ...
                        <View className="flex-row items-center gap-1">
                          <UserX size={10} color={isDark ? "#64748b" : "#94a3b8"} />
